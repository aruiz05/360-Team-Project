...
public class ControllerNewAccount {
	...
	*/
	...
	protected static void doCreateUser() {
		...
		// validate username before attempting to create the account
				String errMessage = UserNameRecognizer.checkForValidUserName(username);
				
				
		// give user error message if username is invalid
		if (!errMessage.isEmpty()) 
		{
					...
					ViewNewAccount.alertUsernamePasswordError.setContentText(errMessage);
