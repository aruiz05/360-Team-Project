	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				//  2: a ., -, _, & makes it transition to state 2 
				...
				// ., -, _, & -> State 2
				else if (currentChar == '.' || currentChar == '_' || currentChar == '-' || currentChar == '&') {		// Check for separators
					nextState = 2;
			...
			case 2: 
				// State 2 deals with a character after a separator (. - _ &) in the name.
		...
		case 0:
			...
			userNameRecognizerErrorMessage += "A UserName must start with letters A-Z, a-z.\n";
